...
let StaffService = (() => {
    ...
    let _classThis;
    var StaffService = _classThis = class {
        constructor(prisma) {
            this.prisma = prisma;
        }
        /**
         ...
         */
        async inviteStaff(businessId, email) {
            ...
            return this.prisma.staffInvite.create({
                data: {
                    ...
                    businessId,
                    token,
                    expiresAt: (0, date_fns_1.addDays)(new Date(), 1), // 24 hours
                },
            });
        }
        /**
         ...
         */
        async assignBooking(bookingId, staffUserId, businessId) {
            ...
            if (!staff) {
                throw new common_1.ForbiddenException('Staff not part of this business');
            }
