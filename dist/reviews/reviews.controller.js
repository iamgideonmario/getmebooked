...
let ReviewsController = (() => {
    ...
    let _businessReviews_decorators;
    var ReviewsController = _classThis = class {
        ...
        async submitReview(bookingId, body, req, res) {
            await this.reviewsService.createReview(bookingId, req.user.id, Number(body.rating), body.comment);
            return res.redirect('/dashboard');
        }
        async businessReviews(businessId, res) {
    ...
    (() => {
        ...
        _submitReview_decorators = [(0, common_1.Post)(':bookingId')];
        _businessReviews_decorators = [(0, common_1.Get)('business/:businessId')];
        ...
        __esDecorate(_classThis, null, _businessReviews_decorators, { kind: "method", name: "businessReviews", static: false, private: false, access: { has: obj => "businessReviews" in obj, get: obj => obj.businessReviews }, metadata: _metadata }, null, _instanceExtraInitializers);
