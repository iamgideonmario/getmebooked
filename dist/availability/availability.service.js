...
let AvailabilityService = (() => {
    ...
    var AvailabilityService = _classThis = class {
         ...
         */
        async isSlotAvailable(businessId, staffId, startUtc, endUtc) {
         ...
         */
        async createAvailability(businessId, dayOfWeek, startTime, endTime, staffId) {
            if (startTime >= endTime) {
                throw new common_1.ForbiddenException('Invalid time range');
            }
         ...
         */
        async getAvailability(businessId, staffId) {
